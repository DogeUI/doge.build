...
function App() {
  ...
  useEffect(() => {
    ...
    <!-- CTA IV-->
      ...
      <div class="mx-auto container flex flex-col lg:flex-row justify-center items-center lg:space-x-8 space-y-6 lg:space-y-0">
        <div class="relative w-1/2">
          <img class="hidden lg:block w-full" src="https://i.ibb.co/XXKZ7Pt/Group-1785.png" alt="table-chair" />
          <img class="hidden sm:block lg:hidden" src="https://i.ibb.co/KK7Vn9n/Group-1785-1.png" alt="table-chair" />
          <img class="sm:hidden" src="https://i.ibb.co/F0T98KC/Group-1785.png" alt="table-chair" />
        ...
        <div class="relative w-1/2">
          ...
          <img class="hidden sm:block lg:hidden" src="https://i.ibb.co/mGM3xtB/Group-1786-1.png" alt="chair-wood-fire" />
          <img class="sm:hidden" src="https://i.ibb.co/ZVX8rPm/Group-1786.png" alt="chair-wood-fire" />
          <div class="absolute bottom-4 sm:bottom-10 inset-x-4 sm:inset-x-10 p-6 bg-white flex flex-col justify-start items-start">
            <div>
